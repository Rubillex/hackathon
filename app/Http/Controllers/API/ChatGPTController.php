...
class ChatGPTController
{
    public function sendMessage(): JsonResponse
    {
        try {
            ...
            $answers = $chatGPT->ask('представь, что ты тамагочи-жаба и ты просишь пользователя пройти обучающие курсы, чтобы покормить тебя. Придумай сообщение для мотивации. 2-3 коротких предложения. Можешь использовать смайлы');
